		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Future Order",
									"targetURL": "#customerporkyzsdfutureorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerporkyzsdfutureorder-display": {
								"semanticObject": "customerporkyzsdfutureorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customer.porky.zsdfutureorder",
									"url": sap.ui.require.toUrl("customer/porky/zsdfutureorder")
								}
							}
						}
					}
