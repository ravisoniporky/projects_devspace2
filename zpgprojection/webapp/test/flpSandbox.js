		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#customerporkyzpgprojection-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerporkyzpgprojection-display": {
								"semanticObject": "customerporkyzpgprojection",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customer.porky.zpgprojection",
									"url": sap.ui.require.toUrl("customer/porky/zpgprojection")
								}
							}
						}
					}
