		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#customerporkyzsdinfoovpc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerporkyzsdinfoovpc-display": {
								"semanticObject": "customerporkyzsdinfoovpc",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customer.porky.zsdinfoovpc",
									"url": sap.ui.require.toUrl("customer/porky/zsdinfoovpc")
								}
							}
						}
					}
