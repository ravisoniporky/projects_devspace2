		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Material List",
									"targetURL": "#customerporkyzmmmatlist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerporkyzmmmatlist-display": {
								"semanticObject": "customerporkyzmmmatlist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customer.porky.zmmmatlist",
									"url": sap.ui.require.toUrl("customer/porky/zmmmatlist")
								}
							}
						}
					}
