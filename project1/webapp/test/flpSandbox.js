		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zxrefmat_v2",
									"targetURL": "#customerporkyproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerporkyproject1-display": {
								"semanticObject": "customerporkyproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customer.porky.project1",
									"url": sap.ui.require.toUrl("customer/porky/project1")
								}
							}
						}
					}
