		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#customerporkyzmmxref-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerporkyzmmxref-display": {
								"semanticObject": "customerporkyzmmxref",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customer.porky.zmmxref",
									"url": sap.ui.require.toUrl("customer/porky/zmmxref")
								}
							}
						}
					}
