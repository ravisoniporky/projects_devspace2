		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Field Rep App",
									"targetURL": "#customerporkyzfieldrepvisit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerporkyzfieldrepvisit-display": {
								"semanticObject": "customerporkyzfieldrepvisit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customer.porky.zfieldrepvisit",
									"url": sap.ui.require.toUrl("customer/porky/zfieldrepvisit")
								}
							}
						}
					}
