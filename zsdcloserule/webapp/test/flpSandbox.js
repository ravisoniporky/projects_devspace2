		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Close Rule App",
									"targetURL": "#customerporkyzsdcloserule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerporkyzsdcloserule-display": {
								"semanticObject": "customerporkyzsdcloserule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customer.porky.zsdcloserule",
									"url": sap.ui.require.toUrl("customer/porky/zsdcloserule")
								}
							}
						}
					}
