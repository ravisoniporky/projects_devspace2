		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#customerporkyzmmpurchdash-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerporkyzmmpurchdash-display": {
								"semanticObject": "customerporkyzmmpurchdash",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customer.porky.zmmpurchdash",
									"url": sap.ui.require.toUrl("customer/porky/zmmpurchdash")
								}
							}
						}
					}
