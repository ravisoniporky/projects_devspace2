		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#customerporkyzbpcontactcreate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerporkyzbpcontactcreate-display": {
								"semanticObject": "customerporkyzbpcontactcreate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customer.porky.zbpcontactcreate",
									"url": sap.ui.require.toUrl("customer/porky/zbpcontactcreate")
								}
							}
						}
					}
