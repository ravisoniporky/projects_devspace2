...
import { type AdpWriterConfig, type CustomConfig, type TypesConfig, type CfAdpWriterConfig, type DescriptorVariant } from '../types';
 ...
 */
export declare function writeCfTemplates(basePath: string, variant: DescriptorVariant, config: CfAdpWriterConfig, fs: Editor): Promise<void>;
