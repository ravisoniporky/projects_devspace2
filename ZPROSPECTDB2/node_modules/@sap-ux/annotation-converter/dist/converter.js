...
exports.addValueListWithReferences = exports.convert = exports.CONVERTER_ROOT = void 0;
...
function addValueListWithReferences(convertedMetadata, rawVHMetadata) {
    const converter = convertedMetadata.getConverter();
    converter.addExtraMetadata(rawVHMetadata);
    // Force reset the converted data
    converter.reset();
}
exports.addValueListWithReferences = addValueListWithReferences;
