            ...
            onInit: function () {
                ...
                this.getModel().attachRequestCompleted(function(oEvent){
                  ...
                  if(filter.includes("CompanyCode") && filter.includes("SalesOrganization") && filter.includes("Customer")){
                    ...
                    defaultModel1.read("/ZCSD_CUSTSOSHIPMENT", {
                      urlParameters: {
                        "$filter" : filters
                      ...
                      success: function (oData, oResponse) {
                        ...
                        that.getView().setModel(new sap.ui.model.json.JSONModel(oData), "shipmentModel");
                      ...
                      error: function (oError) {
                        ...
                        that.getView().setModel(new sap.ui.model.json.JSONModel({}, "shipmentModel"));
                      }
                    });
